...
RestaurantDetailResponse restaurantsDetailFromJson(String str) => RestaurantDetailResponse.fromJson(json.decode(str));

String restaurantsDetailToJson(RestaurantDetailResponse data) => json.encode(data.toJson());
